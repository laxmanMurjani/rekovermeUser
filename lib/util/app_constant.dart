...
class AppImage {
  ...
  static String runCar = "$_basePath/run_car.png";
  static String time = "$_basePath/time.png";
  ...
  static String sosSiren = "$_basePath/sos_siren.png";
  ...
  static String pastRide = "$_basePath/past_ride.png";
  static String account = "$_basePath/acount.png";
  static String maps = "$_basePath/maps.png";
  ...
  static String logo1 = "$_basePath/rekoverme_user_logo.jpg";
  ...
  static String pencil = "$_basePath/pencil.png";
  static String arbyTime = "$_basePath/arby_time.png";
  static String searchCar = "$_basePath/search_car.png";
  ...
  static String roadVehicle = "$_basePath/roadVehicle.png";
  static String skyBlueMsg = "$_basePath/skyBlueMsg2.jpg";
  ...
  static String rekovermeLogo = "$_basePath/rekoverme_user_logo.jpg";
  static String truckImage = "$_basePath/truckImae.jpg";
  static String launching1 = "$_basePath/launching1.png";
  static String launching2 = "$_basePath/launching2.png";
  static String assist11 = "$_basePath/11.png";
  static String assist22 = "$_basePath/22.png";
}
...
class AppString {
  static String googleMapKey = "AIzaSyAzSzTEEfLLWOAyeNlXG5DpOyGNU0GdTUE";
